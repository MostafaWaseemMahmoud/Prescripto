...
const FindDoctorAccount = () => {
    ...
    const validateForm = async ()=> {
        ...
        try {
            const res = await axios.get("https://prescripto-backend.up.railway.app/mng/allpatinets");
        ...
        <h1>Email  OR  Password  Error</h1>
            ...
            <div className="login-field">
                <div className="login">
                    ...
                    <p className="outLink">Are You Doctor? <a onClick={()=>Navigate("/create/doctor")}>Find Doctor Account</a></p>
                </div>
            </div>
        </div>
  );
